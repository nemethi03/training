...
Parancssori alkalmazás edzések nyilvántartásához. Kardió és súlyzós gyakorlatokat
...
- **Új gyakorlat rögzítése** - kardió (időtartam percben) vagy súlyzós (sorozat/ismétlés/súly)
...
models/
  exercise.py        - gyakorlat osztályok (alap, kardió, súlyzós)
